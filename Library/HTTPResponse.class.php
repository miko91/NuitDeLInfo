...
class HTTPResponse
{
	...
	public function redirect404($name)
	{
		$this->page = new Page($this->app);
		$this->page->setContentFile(__DIR__.'/../Errors/'.$name.'_404.html');
	...
	public function setCookie($name, $value = null, $expire = -1, $path = null, $domain = null, $secure = false, $httpOnly = true)
	{
