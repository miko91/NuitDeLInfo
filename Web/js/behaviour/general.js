var App = function () {
  ...
  var dashboard = function(){
    ...
    $(".spk3").sparkline([5,6,7,9,9,5,3,2,2,4,6,7,10,20], {
    type: 'line',
    lineColor: '#258FEC',
    fillColor: '#4A8CF7',
    spotColor: false,
  ...
  var masks = function(){
	...
	$("[data-mask='phone-fr']").mask("99 99 99 99 99");
	$("[data-mask='cp']").mask("99 999");
  ...
  var dataTables = function(){  
	...
	$('.noColumnDef').dataTable({
		...
		"oLanguage": {
			...
			"sInfo": "Entrée _START_ à _END_ de _TOTAL_ résultats",
			"sInfoEmpty": "Entrée 0 à 0 de 0 résultats",
			"sInfoFiltered": "(Filtré de _MAX_ total résultats)",
			"sSearch": "Recherche : ",
			"oPaginate": {
				"sPrevious": "Précédent",
				"sNext": "Suivant"
